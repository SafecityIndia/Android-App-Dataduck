...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["editreport-editreport-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppEditreportEditreportPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppEditreportEditreportRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditreportPageRoutingModule", function () {
      return EditreportPageRoutingModule;
    });
    /* harmony import */
    ...
    var _editreport_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./editreport.page */
    ...
    var EditreportPageRoutingModule = function EditreportPageRoutingModule() {
      _classCallCheck(this, EditreportPageRoutingModule);
    };

    EditreportPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppEditreportEditreportModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditreportPageModule", function () {
      return EditreportPageModule;
    });
    /* harmony import */
    ...
    var _editreport_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./editreport-routing.module */
    "./src/app/editreport/editreport-routing.module.ts");
    /* harmony import */


    var _editreport_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./editreport.page */
    "./src/app/editreport/editreport.page.ts");
    /* harmony import */
    ...
    var EditreportPageModule = function EditreportPageModule() {
      _classCallCheck(this, EditreportPageModule);
    };

    EditreportPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"], _editreport_routing_module__WEBPACK_IMPORTED_MODULE_5__["EditreportPageRoutingModule"]],
  ...
  /***/
  function srcAppEditreportEditreportPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppEditreportEditreportPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditreportPage", function () {
    ...
    var EditreportPage = /*#__PURE__*/function () {
      function EditreportPage(route, translate, navController, sharedservice, router, httpClient) {
        var _this = this;

        _classCallCheck(this, EditreportPage);
        ...
        console.log(incidentEditForm); // incidentEditForm.init()
        ...
        this.route.queryParams.subscribe(function (params) {
          if (_this.router.getCurrentNavigation().extras.state) {
            ...
            _this.selected_inc_id = _this.data[0].id;

            _this.fetch_categories();
      ...
      _createClass(EditreportPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "fetch_categories",
        value: function fetch_categories() {
          var _this2 = this;
          ...
          this.sharedservice.sharedPostRequest('get-forms', data).subscribe(function (rdata) {
            console.log(rdata);
            _this2.category = rdata.categories;

            _this2.fetchIncidentDetail(_this2.data[0].id, _this2.category);
          }, function (error) {
        ...
        key: "final_Submit",
        value: function final_Submit() {
          if (!incidentEditForm.valid()) return false;
          console.log('form is valid! Yeah!');
          var answersArr = incidentEditForm.getAnswers();
          console.log(answersArr);
          var self = this; // Send Update Request

          var data = new FormData();
          data.append('incident_id', this.selected_inc_id);
          data.append('incident_data', JSON.stringify(answersArr));
          this.sharedservice.sharedPostRequest('reported-incident/update', data).subscribe(function (rdata) {
            console.log(rdata);
        ...
        key: "fetchIncidentDetail",
        value: function fetchIncidentDetail(incidentId, category) {
          var self = this;
          ...
          $.ajax({
            ...
            if (data.status) {
              ...
              var primary_data = {
                'primary': this.incidentData.answers.primary
              };
              console.log(primary_data);
              this.incidentData.answers = primary_data;
              console.log(this.incidentData);
              console.log(this.incidentData.answers); //var baseURL = 'http://101.53.143.7/~dataduck/safecity_webapp/';

              incidentEditForm.init(this.incidentData, self.baseURL, category); // Set Details
            } else {// things went wrong!
              }
          }).fail(function () {
            console.log("error");
          }).always(function () {
        ...
        key: "inits",
        value: function inits(incidentData) {
          ...
          $.ajax({
            ...
            if (data.status == true) {
              console.log("in edit!");
              $("#edit_div").html("");
              this.questionsObj = data.data; // Iterate through all forms

              for (var i = 0; i < allForms.length; i++) {
                var formAnswers = Object.values(allForms[i]); // Iterate through answers in current form

                for (var j = 0; j < formAnswers.length; j++) {
                  this.answerObj = formAnswers[j]; // Create appropriate Question element for current answer
              ...
              $("#edit_div").html(this.divList); // Initialize Events
        ...
        value: function initializeEvents() {
          ...
          console.log(datePicker); // $('#datepicker').datetimepicker({
          //      format: 'YYYY-MM-DD', 
          //      todayHighlight: true,
          ...
          var timePickerEnd = $("#timerangepickerend .parent-rangeend-field").val(); // $("#timepicker, #timerangepickerstart, #timerangepickerend").datetimepicker({
          //         format: 'LT',
          //         ignoreReadonly: true,
          //         useCurrent: false
          //         /*buttons: {
          ...
          $("#timerangepickerstart").on("change.datetimepicker", function (e) {
            ...
            $(".timepicker-container").addClass('nonactive'); // Restrict time selection
          ...
          $(".parent-option-field[type=text]").keydown(function (event) {
            ...
            if (validation_type == 'number') {
              var key = event.charCode || event.keyCode || 0; // allow backspace, tab, enter, delete, arrows, numbers and keypad numbers ONLY
              // home, end

              var isValidInput = key == 8 || key == 9 || key == 13 || key == 46 || key >= 35 && key <= 40 || key >= 48 && key <= 57 || key >= 96 && key <= 105;
          ...
          $(document).on("click", ".parent-option-field[type=radio]", function (event) {
            ...
            $(this).closest(".question-listing-item").find("input[type=text].suboption-field").addClass("d-none"); // Show texbox if selected option has one

            if ($(this).data("hassubtext") && $(this).is(":checked")) $(this).siblings(".suboption-field").removeClass("d-none"); // Hide all suboptions for selected question

            $(this).closest(".question-listing-item").find(".suboption-container").addClass("d-none");
            $(this).closest(".question-listing-item").find(".suboption-container .suboption-field").prop("checked", false); // Show Suboption if selected option has one

            if ($(this).data("hassuboption") != false) $(this).siblings(".suboption-container").removeClass("d-none"); // Run validation
          ...
          $(document).on("click", ".parent-option-field[type=checkbox]", function (event) {
            if ($(this).data("hassubtext")) {
              ...
              if ($(this).is(":checked")) {
                ...
                $(this).siblings(".suboption-container").find(".suboption-field").prop("checked", false);
                $(this).siblings(".suboption-container").addClass("d-none");
              }
            } // Run validation
        ...
        key: "validateAnswers",
        value: function validateAnswers() {
          // Reset validations
          ...
          $(".question-listing-item").each(function (index, el) {
            ...
            if (type == "text" || type == "incident-address-form" || type == "estimate-datepicker") {
              ...
              $(el).find(".parent-option-field:checked").each(function (subIndex, subEl) {
                // Validate subtext
                ...
                if ($textElement.length > 0) {
                  if ($textElement.val() == "") {
                    ...
                    $textElement.siblings(".invalid-msg").text("This Field is Required");
                  } else {
                    // Remove validation
                  ...
                  if ($suboptionContainer.length > 0) {
                    ...
                    if ($suboptions.length == 0) {
                      ...
                      $suboptionContainer.children(".invalid-msg").text("This Field is Required");
                    } else {
                      // Remove validation
                      $suboptions.removeClass("is-invalid");
                      $suboptionContainer.children(".invalid-msg").text("");
                    }
                  }
                }
              });
        ...
        key: "renderQuestion",
        value: function renderQuestion(questionsObj, answerObj, incidentData) {
          var _a;
          ...
          var questionHtml = "";
          questionHtml += "\n        <div class=\"question-listing-item col-12\" \n          data-answerdetailid=\"".concat(answerObj.detail_id, "\" \n          data-questiontype=\"").concat(question_properties.type, "\" \n          data-questionid=\"").concat(question.id, "\" \n          data-questiontag=\"").concat(question.tags, "\"\n        >\n            <div class=\"label fs-15\">").concat(question.question, "</div>\n    ");
          var optionHtml = "";
          ...
          switch (question_properties.type) {
            case "radio":
              options.forEach(function (option) {
                ...
                var hassuboption = option.suboption_properties != null ? JSON.parse(option.suboption_properties).type : false;
                optionHtml += "\n                    <div class=\"custom-control custom-radio\">\n                      <input type=\"radio\" id=\"option".concat(option.id, "\" name=\"option").concat(question_id, "\" class=\"custom-control-input parent-option-field\" ").concat(isSelected ? "checked" : "", " value=\"").concat(option.id, "\" data-hassubtext=\"").concat(option.textbox_placeholder != null, "\" data-hassuboption=\"").concat(hassuboption, "\">\n                      <label class=\"custom-control-label\" for=\"option").concat(option.id, "\">").concat(option.title, "</label>\n                "); // Suboption text field

                if (option.textbox_placeholder != null) optionHtml += this.renderSubText(answerObj, option, isSelected);else if (hassuboption != false) {
            ...
            case "checkbox":
              ...
              options.forEach(function (option) {
                ...
                var isSelected = answerIdArr.includes(option.id);
                var hassuboption = option.suboption_properties != null ? JSON.parse(option.suboption_properties).type : false;
                var fieldId = question.is_category == true ? "catoption" + option.id : "option" + option.id;
                optionHtml += "\n                    <div class=\"form-check\">\n                      <input class=\"form-check-input parent-option-field\" type=\"checkbox\" id=\"".concat(fieldId, "\" name=\"").concat(question_id, "\" ").concat(isSelected ? "checked" : "", "  value=\"").concat(option.id, "\" data-hassubtext=\"").concat(option.textbox_placeholder != null, "\" data-hassuboption=\"").concat(hassuboption != null, "\">\n                      <label class=\"form-check-label\" for=\"").concat(fieldId, "\">\n                        ").concat(option.title, "\n                      </label>\n                "); // Suboption text field
            ...
            case "text":
              ...
              optionHtml += "\n                <input type=\"text\" id=\"option".concat(question_id, "text\" class=\"form-control parent-option-field\" value=\"").concat(answerObj.answer, "\" data-required=\"").concat(isRequired, "\" />\n            ");
              break;

            case "estimate-datepicker":
              var isEstimate = incidentData.is_date_estimate == 0 ? true : false;
              optionHtml += "\n        <div class=\"input-group date\" id=\"datepicker\" data-target-input=\"nearest\">\n          <input type=\"text\" id=\"option".concat(question_id, "text\" class=\"form-control parent-option-field datetimepicker-input\" value=\"").concat(incidentData.incident_date, "\" data-target=\"#datepicker\" readonly=\"true\" />\n          <div class=\"input-group-append\" data-target=\"#datepicker\" data-toggle=\"datetimepicker\">\n                        <div class=\"input-group-text\"><i class=\"fa fa-calendar\"></i></div>\n                    </div>\n        </div>\n\n                <div class=\"form-check\">\n                    <input class=\"form-check-input parent-estimate-field\" type=\"checkbox\" id=\"option").concat(question_id, "checked\" name=\"option").concat(question_id, "\" ").concat(isEstimate ? "checked" : "", " >\n                    <label class=\"form-check-label\" for=\"option").concat(question_id, "checked\">This is an estimate</label>\n                </div>\n          ");
              break;
          ...
          $(".question-listing-item").each(function (index, el) {
            ...
            switch (type) {
              ...
              case "radio":
                ...
                self.checkbox_answers = selectedOptionElem.val(); // Set Subtext value if any

                if ($(selectedOptionElem).data("hassubtext")) radio_other_answers[self.answerObj.answer_id] = $(selectedOptionElem).siblings(".suboption-field").val(); // Set Suboption value if any

                $(el).find(".parent-option-field:checked").siblings(".suboption-container").find(".suboption-field:checked").each(function (checkedInder, checkedEl) {
              ...
              case "checkbox":
                ...
                $(el).find(".parent-option-field:checked").each(function (checkedIndex, checkedEl) {
                  self.checkbox_answers += "," + $(checkedEl).val(); // Set Subtext value if any

                  if ($(checkedEl).data("hassubtext")) checkbox_other_answers[JSON.stringify($(checkedEl).val())] = $(checkedEl).siblings(".suboption-field").val(); // Set Suboption value if any

                  if ($(checkedEl).data("hassuboption") != false) {
                    $(checkedEl).siblings(".suboption-container").find(".suboption-field:checked").each(function (checkedInder, checkedEl) {
                      self.checkbox_answers += "," + $(checkedEl).val();
                    });
                  }
                });
              ...
              case "estimate-datepicker":
                ...
                self.answerObj.answer = $(el).find(".parent-option-field").val(); //answerObj.isEstimate = $(el).find('.parent-estimate-field').is(':checked');

                var isEstimate = $(el).find(".parent-estimate-field").is(":checked"); // Set AnswerJson
              ...
              case "estimate-time-or-rangepicker":
                ...
                self.answerObj.answer_id = 0;
                self.answerObj.answer = start_time == "" || end_time == "" ? time : start_time + "-" + end_time; //answerObj.isEstimate = start_time!='' && end_time!='' ? true:$(el).find('.parent-estimate-field').is(':checked');

                var isEstimate = start_time != "" && end_time != "" ? true : $(el).find(".parent-estimate-field").is(":checked"); // Set AnswerJson
              ...
              case "incident-address-form":
                self.answerObj.answer_id = 0; // Set AnswerJson

                self.answerObj.answer_json = {}; //answerObj.address = editaddressForm.getAddress();
        ...
        key: "renderSubText",
        value: function renderSubText(answerObj, option, isSelected) {
          var optionHtml;
          var otherAnswer = JSON.parse(answerObj.other_answers);
          console.log(otherAnswer);

          try {
            var placeholder = JSON.parse(option.textbox_placeholder).placeholder;
          } catch (_a) {
            var placeholder = option.textbox_placeholder;
          }

          optionHtml = "\n        <input type=\"text\" class=\"form-control ".concat(isSelected ? "" : "d-none", " suboption-field\" value=\"").concat(otherAnswer[option.id] != undefined ? otherAnswer[option.id] : "", "\" placeholder=\"").concat(placeholder, "\" />\n    ");
          optionHtml += '<div class="invalid-msg text-danger"></div>';
          return optionHtml;
        }
      }, {
        key: "renderSubOptions",
        value: function renderSubOptions(question_id, answerIdArr, hassuboption, elemsuboptions, isSelected) {
          var optionHtml = "<div class=\"suboption-container ".concat(isSelected ? "" : "d-none", "\">");
          elemsuboptions.forEach(function (elemsuboption) {
            ...
            if (hassuboption == "checkbox") {
              optionHtml += "\n                <div class=\"form-check\">\n                    <input class=\"form-check-input suboption-field\" type=\"checkbox\" id=\"suboption".concat(elemsuboption.id, "\" name=\"suboption").concat(question_id, "\" value=\"").concat(elemsuboption.id, "\" data-hassubtext=\"").concat(elemsuboption.textbox_placeholder != null, "\" ").concat(isSubOptionSelected ? "checked" : "", ">\n                    <label class=\"form-check-label\" for=\"suboption").concat(elemsuboption.id, "\">\n                      ").concat(elemsuboption.title, "\n                    </label>\n                </div>\n            ");
            } else if (hassuboption == "radio") {
              optionHtml += "\n                <div class=\"custom-control custom-radio\">\n                    <input type=\"radio\" id=\"suboption".concat(elemsuboption.id, "\" name=\"suboption").concat(question_id, "\" class=\"custom-control-input suboption-field\" ").concat(isSelected ? "checked" : "", " value=\"").concat(elemsuboption.id, "\" data-hassubtext=\"").concat(elemsuboption.textbox_placeholder != null, "\" ").concat(isSubOptionSelected ? "checked" : "", ">\n                    <label class=\"custom-control-label\" for=\"suboption").concat(elemsuboption.id, "\">").concat(elemsuboption.title, "</label>\n                </div>\n            ");
            }
          });
          optionHtml += '<div class="invalid-msg text-danger"></div>';
          optionHtml += "</div>";
        ...
        key: "init",
        value: function init(newLatitude, newLongitude, newBuilding, newLandmark, newArea, newCity, newState, newCountry) {
          ...
          var elementHtml = "\n    <div class=\"newedit\">\n      <label>Locate address on map</label>\n            <input type=\"text\" id=\"search_address\" placeholder=\"Start Typing\" class=\"form-control parent-option-field\" value=\"\" />\n          </div>\n          <div class=\"mapouter\" id=\"editMap\" style=\"height:467px\">\n    </div>\n    <div class=\"newedit\">\n              <label>Building</label>\n            <input type=\"text\" id=\"editbuilding\" class=\"form-control parent-option-field\" value=\"".concat(this.building, "\" />\n    </div>\n    <div class=\"newedit\">\n              <label>Landmark</label>\n            <input type=\"text\" id=\"editlandmark\" class=\"form-control parent-option-field\" value=\"").concat(this.landmark, "\" />\n          </div>\n          <div class=\"newedit\">\n              <label>Area</label>\n            <input type=\"text\" id=\"editarea\" class=\"form-control parent-option-field\" value=\"").concat(this.area, "\" data-required=\"true\" />\n          </div>\n          <div class=\"newedit\">\n              <label>City</label>\n            <input type=\"text\" id=\"editcity\" class=\"form-control parent-option-field\" value=\"").concat(this.city, "\" data-required=\"true\" />\n          </div>\n          <div class=\"newedit\">\n              <label>State</label>\n            <input type=\"text\" id=\"editstate\" class=\"form-control parent-option-field\" value=\"").concat(this.state, "\" data-required=\"true\" />\n          </div>\n          <div class=\"newedit\">\n              <label>Country</label>\n            <input type=\"text\" id=\"editcountry\" class=\"form-control parent-option-field\" value=\"").concat(this.country, "\" data-required=\"true\" />\n      </div>\n   ");
          return elementHtml;
        }
      }, {
        key: "getAddress",
        ...
        value: function initMap(searchFieldId) {
          ...
          if (google) {
            ...
            this.mapMarker.setMap(this.map); // On drag end
            ...
            google.maps.event.addListener(this.mapMarker, 'dragend', function () {
              ...
              this.longitude = JSON.stringify(this.mapMarker.getPosition().lng()); // Reverse Geocode to get Address
            ...
            var searchBox = new google.maps.places.SearchBox(this.input); // Bias the SearchBox results towards current map's viewport.

            this.map.addListener("bounds_changed", function () {
              searchBox.setBounds(_this3.map.getBounds());
            ...
            searchBox.addListener("places_changed", function () {
              ...
              if (places.length == 0) {
                _this3.resetFields("No results found");

                return;
              }

              _this3.place = places[0]; // Set Coordinates

              _this3.latitude = _this3.place.geometry.location.lat();
              _this3.longitude = _this3.place.geometry.location.lng();

              _this3.updateMarker();

              var addcomponent = _this3.place.address_components; // Set Address

              _this3.setAddress(addcomponent);
            });
          }
        } // Reverse Geocode
        ...
        value: function geocodeLatLng() {
          ...
          this.geocoder.geocode({
            ...
            if (status === "OK") {
              if (results[0]) {
                // Set Address
                _this4.setAddress(results[0].address_components);
              } else {
                _this4.resetFields("No results found");
              }
            } else {
              _this4.resetFields("Geocoder failed due to: " + status);
            }
          });
        }
      }, {
    ...
    EditreportPage.ctorParameters = function () {
      return [{
    ...
    EditreportPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-editreport',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./editreport.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/editreport/editreport.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./editreport.page.scss */
      "./src/app/editreport/editreport.page.scss"))["default"]]
    })], EditreportPage);
    /***/
  }
}]);
//# sourceMappingURL=editreport-editreport-module-es5.js.map