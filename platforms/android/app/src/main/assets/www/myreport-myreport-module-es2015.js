...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyreportPageRoutingModule", function() { return MyreportPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _myreport_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./myreport.page */ "./src/app/myreport/myreport.page.ts");
...
let MyreportPageRoutingModule = class MyreportPageRoutingModule {
};
MyreportPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyreportPageModule", function() { return MyreportPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _myreport_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./myreport-routing.module */ "./src/app/myreport/myreport-routing.module.ts");
/* harmony import */ var _myreport_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./myreport.page */ "./src/app/myreport/myreport.page.ts");
...
let MyreportPageModule = class MyreportPageModule {
};
MyreportPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _myreport_routing_module__WEBPACK_IMPORTED_MODULE_6__["MyreportPageRoutingModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateModule"].forChild(),
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyreportPage", function() { return MyreportPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let MyreportPage = class MyreportPage {
    constructor(navController, translate, sharedservice, router) {
    ...
    getreport() {
        ...
        this.sharedservice.sharedPostRequest_webappurl('user-reported-incidents', data).subscribe((rdata) => {
            console.log(rdata);
            ...
            for (var i = 0; i < this.incident_list.length; i++) {
                ...
                var yrs;
                this.translate.get('yrs').subscribe((res) => {
                    yrs = res;
                });
                ...
                this.translate.get('prefer_not_to_say').subscribe((res) => {
                ...
                // code changed by sonam - 16-10-2020 start
                var around;
                this.translate.get('around').subscribe((res) => {
                    around = res;
                });
                var On;
                this.translate.get('On').subscribe((res) => {
                    On = res;
                });
                var At;
                this.translate.get('At').subscribe((res) => {
                    At = res;
                });
                var Between;
                this.translate.get('Between').subscribe((res) => {
                    Between = res;
                });
                ...
                for (var j = 0; j < incidentdata_answers_length; j++) {
                    ...
                    if (incident_question_tag == "attack_reason") {
                        ...
                        this.translate.get('what_let_to_attck').subscribe((res) => {
                        ...
                        this.translate.get('medical_help_received').subscribe((res) => {
                            medical_help_received = res;
                        });
                        var medical_hlp_noy_rcvd;
                        this.translate.get('medical_hlp_noy_rcvd').subscribe((res) => {
                        ...
                        if (police_tag == "Yes I did") {
                            ...
                            this.translate.get('police_Report_filed').subscribe((res) => {
                            ...
                            this.translate.get('police_reprt_not_filed').subscribe((res) => {
                            ...
                            var tried_to_filed;
                            this.translate.get('tried_to_filed').subscribe((res) => {
                                tried_to_filed = res;
                            });
                            ...
                            var intent_to_filed;
                            this.translate.get('intent_to_filed').subscribe((res) => {
                                intent_to_filed = res;
                            });
                            ...
                            var not_sure;
                            this.translate.get('not_sure').subscribe((res) => {
                                not_sure = res;
                            });
...
MyreportPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"] },
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateService"] },
    { type: _shared_service__WEBPACK_IMPORTED_MODULE_5__["SharedService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
MyreportPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-myreport',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./myreport.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/myreport/myreport.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./myreport.page.scss */ "./src/app/myreport/myreport.page.scss")).default]
    })
], MyreportPage);
...
//# sourceMappingURL=myreport-myreport-module-es2015.js.map