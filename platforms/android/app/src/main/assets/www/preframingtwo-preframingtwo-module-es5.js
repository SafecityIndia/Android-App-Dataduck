...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["preframingtwo-preframingtwo-module"], {
  ...
  function srcAppPreframingtwoPreframingtwoRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PreframingtwoPageRoutingModule = function PreframingtwoPageRoutingModule() {
  ...
  function srcAppPreframingtwoPreframingtwoModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PreframingtwoPageModule = function PreframingtwoPageModule() {
  ...
  function srcAppPreframingtwoPreframingtwoPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PreframingtwoPage = /*#__PURE__*/function () {
      function PreframingtwoPage(navController, translate, sharedservice, sanitizer, router) {
        var _this = this;
        ...
        this.sharedservice.sharedPostRequest('faq/getClientResourceList', data).subscribe(function (rdata) {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_7__(".dynamic-success-link1").html(_this.content);
          ...
          jquery__WEBPACK_IMPORTED_MODULE_7__("#estimate").click(function (event) {
            ...
            if (jquery__WEBPACK_IMPORTED_MODULE_7__(this).is(":checked")) {
              ...
              jquery__WEBPACK_IMPORTED_MODULE_7__(".dynamic-click").removeAttr("disabled"); // $(".checkerrors").hide()
      ...
      _createClass(PreframingtwoPage, [{
        ...
        value: function experiance() {
          ...
          this.sharedservice.sharedPostRequest('faq/getClientResourceList', data).subscribe(function (rdata) {
            ...
            _this2.hide = true;
            jquery__WEBPACK_IMPORTED_MODULE_7__(".dynamic-success-link1").html(_this2.content);
            jquery__WEBPACK_IMPORTED_MODULE_7__(".checkerrors").hide();
            jquery__WEBPACK_IMPORTED_MODULE_7__(".dynamic-click").attr("disabled", "disabled");
            jquery__WEBPACK_IMPORTED_MODULE_7__(".dynamic-click").click(function (event) {
              event.preventDefault();
